...
class historyCheckWillowbrook():
    ...
    def postTriggerEvent( self, listOfCustomerAndSites) :
        ...
        "incident_key":"%s",
        "event_type": "trigger",
        "description": "Willowbrook has stale histories",
        "client": "Willowbrook Stale History Warning Tool",
        "details": %s
        }
...
if __name__ == '__main__':
    ...
    batchChecker = historyCheckWillowbrook(sys.argv[1])
